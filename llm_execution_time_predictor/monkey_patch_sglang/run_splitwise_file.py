...
async def launch_jobs(engine, data_file, max_job_send_time, max_rps, rps_scale=1.0, max_window_time=None):
    avg_rps = 0.0
    num_jobs = 0
...
async def main(model, data_file, max_job_send_time, max_rps, rps_scale, max_window_time=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_window_time", type=int, default=None, help="Maximum time (seconds) to wait for all jobs to complete before cancelling")
